                ...
                <div className='row'>
                    ...
                    <div className='contents col-12'>
                        <div className='code-message'>
                            <p>
                                <span>1</span>
                                <span>const </span><span>messages = [</span>
                            </p>
                            <p>
                                <span>2</span>
                            ...
                            <p>
                                <span>3</span>
                                <span>"Welcome to my website!"</span><span>,</span>
                            </p>
                            <p>
                                <span>4</span>
                                <span>"I hope you enjoy your visit!"<span>,</span></span>
                            </p>
                            <p>
                                <span>5</span>
                                <span>"Thank you for visiting me today!"</span><span>,</span></p>
                            <p>
                                <span>6</span>
                                ];
                            </p>

            ...
            <div className="col-10">
              <strong>
                ...
                <div>
                  ...
                  I'm an experienced Front-End developer, specializing in
                  creating interactive and engaging user interfaces. My skills
                  span HTML, CSS and JavaScript, and I'm familiar with the
                  latest trends in responsive design. I have expertise in
                  frameworks such as React and Angular, allowing me to transform
                  concepts into attractive and functional visual experiences.
                </div>
                ...
                <div>
                  ...
                  to create solid and efficient systems. My skills include
                  languages such as Java and Node.js, as well as the
                  implementation of SQL and NoSQL databases. I am proficient in
                  building secure and scalable APIs, ensuring robust performance
                  and smooth maintenance. I am up-to-date with the best
                ...
                <div>
                  ...
                  Specializing in mobile application development, I have
                  expertise in frameworks such as React Native and Flutter. My
                  skills cover the creation of native apps for iOS and Android,
                  offering a unified, high-quality experience. My
                  results-oriented approach translates into intuitive and
                  efficient apps, incorporating the latest innovations in UX/UI
